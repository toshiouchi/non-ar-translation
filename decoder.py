...
class Decoder(nn.Module):
    ...
    def forward(self, encoder_outs, decoder_targets, dec_target_padding_mask, dec_padding_mask):
        ...
        for i, block in enumerate( self.blocks ):
            ...
            x, attn1, attn2 = block(x, encoder_outs, dec_target_padding_mask, dec_padding_mask)
