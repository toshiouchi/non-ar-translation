...
Especially encoder output stretch to double with time axis using upsampling module. And, also input_lens as input lengths of encoder is doubled and becomes the input of CTCLoss as output_lens.
