...
if __name__ == "__main__":
    ...
    token_list_path = os.path.join(exp_dir, 'data', unit,
                                   'token_list')
    # 学習結果を出力するディレクトリ
    output_dir = os.path.join(exp_dir, unit+'_model_conv_non_ar_007')
    ...
    #train_dataset = SequenceDataset( "ids_test.txt", pad_id )
    ...
    for epoch in range(max_num_epoch):
        ...
        for phase in ['train', 'validation']:
            ...
            for (features, labels, feat_lens,
                ...
                if (steps + 1 ) % 5 == 0:
                    print( "steps:{},loss:{}".format( steps + 1, loss.item() ) )
